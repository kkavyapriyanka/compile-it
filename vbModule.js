	       		...
	       		if(envData.OS === 'windows')
	       		{
							...
							exec(commmand , function ( error , stdout , stderr ){  
								if(error)
								{
									if(exports.stats)
									{
										console.log('INFO: '.green + filename + '.vb1 contained an error while compiling');
									}
									...
									exec( tempcommand , function ( error , stdout , stderr ){
										...
										if(error.toString().indexOf('Error: stdout maxBuffer exceeded.') != -1)
										...
										else
											{
												if(exports.stats)
												{
													console.log('INFO: '.green + filename + '.vb2 contained an error while executing');
												}
										...
										else
										{
											if(exports.stats)
											{
												console.log('INFO: '.green + filename + '.vb3 successfully compiled and executed !');
											}

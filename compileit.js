...
var javaScriptModule = require('./javascriptModule.js');
...
var netModule=require('./netModule.js')
exports.stats = false;
...
exports.compileJS = function ( envData ,  code , fn ){
	if(exports.stats)
	javaScriptModule.stats = true;
		javaScriptModule.compileJS(envData , code , fn );
}

exports.compileJSWithInput = function ( envData , code , input ,  fn ) { 
	if(exports.stats)
	javaScriptModule.stats = true;
	javaScriptModule.compileJSWithInput(envData , code , input , fn );	
}
...
exports.compileNet = function ( envData ,  code , fn ){
	if(exports.stats)
	netModule.stats = true;
	netModule.compileNet(envData , code , fn );
}

exports.compileNetWithInput = function ( envData , code , input ,  fn ) { 
	if(exports.stats)
	netModule.stats = true;
	netModule.compileNetWithInput(envData , code , input , fn );	
}
